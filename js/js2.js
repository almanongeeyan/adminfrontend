    ...
    (p.ClassBody = function () {
        ...
        (p.TGL.showmenu = function (e, t) {
            var n = x(e || ".nk-nav-toggle"),
                ...
                e = { active: "toggle-active", content: l + "-active", body: "nav-shown", overlay: "nk-sidebar-overlay", break: i, close: { profile: !0, menu: !1 } },
                o = t ? u(e, t) : e;
            ...
            x(a).exists() &&
                x(a).each(function (e) {
                    var t = (t = x(a)[e].dataset.maxFiles) ? Number(t) : null,
                        ...
                        t = { autoDiscover: !1, maxFiles: t, maxFilesize: n, acceptedFiles: e || null },
                        n = i ? u(t, i) : t;
        ...
        (p.Custom.Stepper = function (n, e) {
            ...
            r.querySelector("button").addEventListener("click", function (e) {
                ...
                var e = k.form(),
                    t = g - 1;
                e ? h !== g && (v && a[t].classList.add(p), i[t].classList.add(f)) : (v && a[t].classList.remove(p), i[t].classList.remove(f)), y(--g);
            }),
                c.querySelector("button").addEventListener("click", function (e) {
                    e.preventDefault(), k.form() && ((e = g - 1), v && a[e].classList.add(p), i[e].classList.add(f), y(++g));
                }),
                ...
                void 0 !== e &&
                    ...
                    a.forEach(function (t) {
                        t.addEventListener("click", function (e) {
                            matchesSelector(e.target, "button") &&
